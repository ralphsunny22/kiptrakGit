        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{ route('addAccountPost') }}" method="POST" enctype="multipart/form-data">@csrf
              <div class="col-md-12 mb-3">The field labels marked with * are required input fields.</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="account_no" class="form-control @error('account_no') is-invalid @enderror" value="{{ $account_no }}" readonly>
                    @error('account_no')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="account_name" class="form-control @error('account_name') is-invalid @enderror" placeholder="" >
                    @error('account_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="amount" class="form-control amount @error('amount') is-invalid @enderror" placeholder="" >
                    @error('amount')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
