                    ...
                    @foreach ($accounts as $account)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('editAccount', $account->unique_key) }}" class="btn btn-success btn-sm me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"><i class="bi bi-pencil-square"></i></a>
