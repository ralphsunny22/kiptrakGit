  ...
  $(function () {
    ...
    const completeStep = () => {
        document.getElementById('completeBtn').addEventListener('click',()=>{ 
            ...
            $.ajax({
                type:'get',
                url:'/product-upsell-customer-order',
                data:{grand_total:grand_total, unique_key:unique_key, upsell_revenue:upsell_revenue, firstname:firstname,
                    lastname:lastname, phone:phone, email:email, city:city, state:state, country:country, address:address
                    },
