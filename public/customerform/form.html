...
<html lang="en">
    ...
    <head>
        ...
        <!-- Font awesome 5 -->
        <link rel="preload" href="assets/vendor/font-awesome/webfonts/fa-solid-900.woff2" as="font" type="font/woff" crossorigin>
        <link href="assets/vendor/font-awesome/css/all.min.css" type="text/css" rel="stylesheet">
            ...
            <!-- <div class="col-lg-3 col-sm-6 col-12"> 
                <div class="card card-product-grid">
                    ...
                    <div class="info-wrap text-center border-top"> 
                        ...
                        <strong class="price">starting from N${product.minPrice}</strong>
                        <hr>
                ...
                <aside class="col-lg-6">
                    <article class="gallery-wrap gallery-vertical">
                        <a href="#" class="img-big-wrap img-thumbnail bg-light">
                            <img height="520" src="assets/img/product-3.jpg" class="mix-blend-multiply">
                        </a> <!-- img-big-wrap.// --> 
                    ...
                    <article class="card-body border-bottom"> 
                        <div class="row gy-3"> 
                            <div class="col-md-7"> 
                                <div class="itemside"> 
                                    <a href="#" class="aside"> 
                                        <img src="./assets/img/product-1.jpg" class="img-md img-thumbnail"> 
                                    </a> 
                                    <div class="info"> 
                    ...
                    <article class="card-body border-bottom"> 
                        <div class="row gy-3"> 
                            <div class="col-md-7"> 
                                <div class="itemside"> 
                                    <a href="#" class="aside"> 
                                        <img src="./assets/img/product-2.jpg" class="img-md img-thumbnail"> </a> 
                                        <div class="info"> 
                        ...
                        <article class="card-body"> 
                            <div class="row gy-3"> 
                                <div class="col-md-7"> 
                                    <div class="itemside"> 
                                        <a href="#" class="aside"> <img src="./assets/img/product-3.jpg" class="img-md img-thumbnail"> </a> 
                                        <div class="info"> 
